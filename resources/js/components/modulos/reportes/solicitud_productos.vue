    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Reportes - Solicitud de Productos</h1>
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <div class="ml-auto mr-auto col-md-5">
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12" v-if="oReporte.filtro == 'Código de Solicitud'">
                                                <label
                                                    :class="{
                                                        'text-danger':
                                            ...
                                            <div class="form-group col-md-12" v-if="oReporte.filtro == 'Cliente'">
                                                <label
                                                    :class="{
                                                        'text-danger':
                                                            errors.cliente_id,
...
export default {
    data() {
        return {
            ...
            listFiltro: ["Todos", "Código de Solicitud", "Cliente"],
            listSolicitudes: [],
            listClientes: [],
            errors: [],
        };
    ...
    methods: {
        ...
        generaReporte() {
            ...
            axios
                .post(
                    main_url + "/admin/reportes/solicitud_productos",
                    this.oReporte,
                    config
                )
                .then((res) => {
