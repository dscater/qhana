...
export default {
    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: "fonos", label: "Teléfonos", sortable: true },
    ...
    methods: {
        ...
        editarRegistro(item) {
            ...
            this.oCliente.empresa = item.empresa ? item.empresa : "";
            this.oCliente.nombre_encargado = item.nombre_encargado
                ? item.nombre_encargado
                : "";
            this.oCliente.fonos = item.fonos ? item.fonos : "";
        ...
        limpiaCliente() {
            this.oCliente.empresa = "";
            this.oCliente.nombre_encargado = "";
            this.oCliente.fonos = "";
            this.oCliente.dir = "";
